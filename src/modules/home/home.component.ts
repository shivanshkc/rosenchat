...
@Component({
  ...
  animations: [
    trigger('chatListOpenClose', [
      ...
      transition(`${LayoutMode.ChatListOpen} <=> ${LayoutMode.BothOpen}`, [animate('0.2s 100ms ease-out')]),
      transition(`${LayoutMode.ChatBoxOpen} <=> ${LayoutMode.BothOpen}`, [animate('0.2s 100ms ease-out')]),
      transition(`${LayoutMode.ChatListOpen} <=> ${LayoutMode.ChatBoxOpen}`, [animate('0.2s 100ms ease-out')]),
    ]),
    trigger('chatBoxOpenClose', [
      ...
      transition(`${LayoutMode.ChatBoxOpen} <=> ${LayoutMode.BothOpen}`, [animate('0.2s 100ms ease-out')]),
      transition(`${LayoutMode.ChatListOpen} <=> ${LayoutMode.BothOpen}`, [animate('0.2s 100ms ease-out')]),
      transition(`${LayoutMode.ChatBoxOpen} <=> ${LayoutMode.ChatListOpen}`, [animate('0.2s 100ms ease-out')]),
    ]),
  ],
})
